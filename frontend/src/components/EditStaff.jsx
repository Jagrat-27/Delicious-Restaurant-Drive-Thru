...
const EditStaff = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`http://localhost:5000/updatestaff/${formData.id}`, formData)
            .then(() => {
                alert("Member updated successfully!");
                setFormData({ id: "", name: "", email: "" ,password:"",position:""});
                navigate("/staff"); // Redirect to menu page after update
